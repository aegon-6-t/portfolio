        ...
        <div className="py-12">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              <h3 className="text-xl font-bold mb-4">Portfolio BTS SIO</h3>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Étudiant passionné en BTS SIO option SLAM, je développe mes compétences
                en programmation et développement web. Ce portfolio présente mon parcours,
